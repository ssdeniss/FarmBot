...
var BaseProLayout = function BaseProLayout(props) {
  ...
  var _useMergedState = (0, _useMergedState3.default)(function () {
      ...
      if ((0, _proProvider.isNeedOpenHash)() === false) return false;
...
var ProLayout = function ProLayout(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_antd.ConfigProvider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_proProvider.ProConfigProvider, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      autoClearCache: true
    }, darkProps), {}, {
      token: props.token,
