...
var SiderMenu = function SiderMenu(props) {
  ...
  var siderClassName = (0, _classnames.default)("".concat(baseClassName), hashId, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-fixed"), fixSiderbar), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-fixed-mix"), layout === 'mix' && !isMobile && fixSiderbar), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-collapsed"), props.collapsed), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-layout-").concat(layout), layout && !isMobile), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-light"), theme !== 'dark'), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-mix"), layout === 'mix' && !isMobile), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-stylish"), !!stylish), _classNames));
