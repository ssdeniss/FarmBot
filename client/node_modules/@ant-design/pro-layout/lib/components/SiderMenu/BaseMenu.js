...
var MenuUtil = /*#__PURE__*/(0, _createClass2.default)(function MenuUtil(props) {
  ...
  (0, _defineProperty2.default)(this, "getSubMenuOrItem", function (item, level) {
    ...
    if (Array.isArray(children) && children.length > 0) {
      ...
      var defaultTitle = /*#__PURE__*/(0, _jsxRuntime.jsx)(MenuItemTooltip, {
        collapsed: collapsed,
        title: name,
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
          className: (0, _classnames.default)("".concat(baseClassName, "-item-title"), (_this$props3 = _this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.hashId, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-item-title-collapsed"), collapsed), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-group-item-title"), menuType === 'group'), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames)),
      ...
      return [{
        ...
        className: (0, _classnames.default)((_classNames3 = {}, (0, _defineProperty2.default)(_classNames3, "".concat(baseClassName, "-group"), menuType === 'group'), (0, _defineProperty2.default)(_classNames3, "".concat(baseClassName, "-submenu"), menuType !== 'group'), (0, _defineProperty2.default)(_classNames3, "".concat(baseClassName, "-submenu-has-icon"), menuType !== 'group' && shouldHasIcon && iconDom), _classNames3))
      }, isGroup && level === 0 ? {
        type: 'divider',
        prefixCls: prefixCls,
  ...
  (0, _defineProperty2.default)(this, "getMenuItemPath", function (item, level) {
    ...
    var defaultItem = /*#__PURE__*/(0, _jsxRuntime.jsx)(MenuItemTooltip, {
      collapsed: collapsed,
      title: name,
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
        className: (0, _classnames.default)("".concat(baseClassName, "-item-title"), (_this$props10 = _this.props) === null || _this$props10 === void 0 ? void 0 : _this$props10.hashId, (_classNames4 = {}, (0, _defineProperty2.default)(_classNames4, "".concat(baseClassName, "-item-title-collapsed"), collapsed), (0, _defineProperty2.default)(_classNames4, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames4)),
    ...
    if (isHttpUrl) {
      ...
      defaultItem = /*#__PURE__*/(0, _jsxRuntime.jsxs)("span", {
        ...
        className: (0, _classnames.default)("".concat(baseClassName, "-item-title"), (_this$props13 = _this.props) === null || _this$props13 === void 0 ? void 0 : _this$props13.hashId, (_classNames6 = {}, (0, _defineProperty2.default)(_classNames6, "".concat(baseClassName, "-item-title-collapsed"), collapsed), (0, _defineProperty2.default)(_classNames6, "".concat(baseClassName, "-item-link"), true), (0, _defineProperty2.default)(_classNames6, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames6)),
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("span", {
...
var BaseMenu = function BaseMenu(props) {
  ...
  return wrapSSR( /*#__PURE__*/(0, _react.createElement)(_antd.Menu, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, openKeysProps), {}, {
    ...
    className: (0, _classnames.default)(className, hashId, baseClassName, (_classNames8 = {}, (0, _defineProperty2.default)(_classNames8, "".concat(baseClassName, "-horizontal"), mode === 'horizontal'), (0, _defineProperty2.default)(_classNames8, "".concat(baseClassName, "-collapsed"), props.collapsed), _classNames8)),
