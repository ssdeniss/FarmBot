...
var FooterToolbar = function FooterToolbar(props) {
  ...
  var containerDom = (0, _react.useMemo)(function () {
    if ((typeof window === "undefined" ? "undefined" : (0, _typeof2.default)(window)) === undefined || (typeof document === "undefined" ? "undefined" : (0, _typeof2.default)(document)) === undefined) return null;
    // 只读取一次就行了，不然总是的渲染
