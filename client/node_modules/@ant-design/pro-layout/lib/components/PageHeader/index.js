...
var PageHeader = function PageHeader(props) {
  ...
  var className = (0, _classnames.default)(prefixCls, hashId, customizeClassName, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-has-breadcrumb"), !!breadcrumbDom), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-has-footer"), !!footer), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-compact"), compact), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-wide"), contentWidth === 'Fixed'), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-ghost"), true), _classNames));
