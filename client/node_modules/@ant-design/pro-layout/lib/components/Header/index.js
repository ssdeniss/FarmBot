...
var DefaultHeader = function DefaultHeader(props) {
  var _token$layout2, _token$layout2$header, _classNames, _token$layout3, _token$layout3$header, _token$layout4, _token$layout4$header;
  ...
  (0, _react.useEffect)(function () {
    ...
    var dom = (context === null || context === void 0 ? void 0 : (_context$getTargetCon = context.getTargetContainer) === null || _context$getTargetCon === void 0 ? void 0 : _context$getTargetCon.call(context)) || document.body;
    var isFixedHeaderFn = function isFixedHeaderFn() {
      var _token$layout, _token$layout$header;
      var scrollTop = dom.scrollTop;
      if (scrollTop > ((token === null || token === void 0 ? void 0 : (_token$layout = token.layout) === null || _token$layout === void 0 ? void 0 : (_token$layout$header = _token$layout.header) === null || _token$layout$header === void 0 ? void 0 : _token$layout$header.heightLayoutHeader) || 56) && !scrollTop) {
  ...
  }, [token === null || token === void 0 ? void 0 : (_token$layout2 = token.layout) === null || _token$layout2 === void 0 ? void 0 : (_token$layout2$header = _token$layout2.header) === null || _token$layout2$header === void 0 ? void 0 : _token$layout2$header.heightLayoutHeader, needFixedHeader]);
  var isTop = layout === 'top';
  ...
  var className = (0, _classnames.default)(propsClassName, hashId, baseClassName, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-fixed-header"), needFixedHeader), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-fixed-header-scroll"), isFixedHeaderScroll), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-mix"), layout === 'mix'), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-fixed-header-action"), !collapsed), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-top-menu"), isTop), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-header"), true), (0, _defineProperty2.default)(_classNames, "".concat(baseClassName, "-stylish"), !!props.stylish), _classNames));
    ...
    , {
      ...
      children: [needFixedHeader && /*#__PURE__*/(0, _jsxRuntime.jsx)(Header, {
        style: (0, _objectSpread2.default)({
          height: (token === null || token === void 0 ? void 0 : (_token$layout3 = token.layout) === null || _token$layout3 === void 0 ? void 0 : (_token$layout3$header = _token$layout3.header) === null || _token$layout3$header === void 0 ? void 0 : _token$layout3$header.heightLayoutHeader) || 56,
          lineHeight: "".concat((token === null || token === void 0 ? void 0 : (_token$layout4 = token.layout) === null || _token$layout4 === void 0 ? void 0 : (_token$layout4$header = _token$layout4.header) === null || _token$layout4$header === void 0 ? void 0 : _token$layout4$header.heightLayoutHeader) || 56, "px"),
